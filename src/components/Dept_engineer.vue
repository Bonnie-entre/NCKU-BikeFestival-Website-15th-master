    ...
    div(class="dept_layout" )
      ...
      div(class="dept_menu_mobile" v-if="!pc & !dropdown_top & !rightshow")
        ...
        div(class="dropdown_dept__menu" v-if="dropdown")
          label(v-for="(item, index) of dept_mobile" @click="deptIndex=index, rightshow=true; dropdown=false;") {{item}}
      div(class="dept_menu" v-if="pc")
          div(class="dept_title") -工學院-
  ...
  data: function () {
    return {
      ...
      iframeSrc: [
        ...
        'https://drive.google.com/file/d/1aneeu8vbsq1D3dquvtAmbybHUccY9Rj9/preview',
        'https://drive.google.com/file/d/146b9N5xX6ztzHpXlx1fK-mjipkqGNjtu/preview',
        'https://drive.google.com/file/d/1GsfygERK0MZYXOz8tJM4gMAy9Ryl8fm0/preview'
      ],
      guildForm: [
        '',
        'https://reurl.cc/EpVZXn',
        '',
        '',
        '',
        'https://reurl.cc/jk9k2D',
        'https://reurl.cc/jk9k2D',
        '',
        '',
        'https://reurl.cc/Lpapq4',
        '',
        '',
        '',
        '',
      ...
      .dept_menu_mobile{
        ...
        .dropdown_dept__menu{
          ...
          label{
            width: 40vw;
            height: 6vh;
            margin: 0.3vh 1.5vw 0.3vh 1.5vw;
            background: white;
            color: #769BFF;
            font-size: 160%;
            line-height: 6vh;
