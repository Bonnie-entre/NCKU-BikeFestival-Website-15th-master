...
export default {
  ...
  data: function () {
    return {
      ...
      dept: ['政治學系', '法律學系', '心理學系', '經濟學系', '學院QA影片'],
      currentIndex: -1,
      check: false,
      iframeSrc: [
        'https://drive.google.com/file/d/1ej0PpgZYsVDVtLtzy3XJl_GznSF4VROu/preview',
        ...
        'https://drive.google.com/file/d/1x0VjM-pIYTW8dxDJsZDhC_0A5H2FMyZ7/preview'
      ],
      guildForm: [
        '',
